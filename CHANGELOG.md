...
* Initial release. Supports retrieving persistent hardware-backed Device IDs, and real-time monitoring of VPN Status, Debug Mode, and USB Connections on both iOS and Android.
